...
% **************************************************
\newcommand{\thesisTitle}{Project Report}
\newcommand{\thesisName}{Philipp Scholz, Anatoly Obukhov}
\newcommand{\thesisSubject}{Blockchain-based Process Execution with Chrysalis}
\newcommand{\thesisDate}{August 6, 2021}
...
\newcommand{\thesisFirstSupervisor}{Christian Sturm}
...
\input{content/chapter-general-architecture}
 
\input{content/chapter-improvements}
\input{content/subchapter-improvements-restructure}
\input{content/subchapter-improvements-persistence}
\input{content/subchapter-improvements-hyperledger}
\input{content/subchapter-improvements-ethereum-overhaul}
\input{content/subchapter-improvements-summary}
	
\input{content/chapter-open-issues} 

\input{content/chapter-caterpillar}

\input{content/chapter-resources} 
